...
function dealToken(msg) {
    ...
    if (status != 1)//运营商不支持或已下线
    {
        ...
        {
            window.location.href = "/template/ValidateBusiness.html?token=" + jxl.defaultReqMsg.token + "&website=" + jxl.defaultReqMsg.website;
        }
    }
}
...
function dealSetFlag_bus(msg) {
    ...
    window.location.href = "/InterFace/ChkRiskArea.ashx";
}
...
function dealSetFlag_bus(msg) {
    ...
    window.location.href = "/InterFace/ValidateEmail.ashx";
}
