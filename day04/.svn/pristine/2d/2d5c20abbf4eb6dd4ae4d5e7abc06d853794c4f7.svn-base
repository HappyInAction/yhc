...
function jxlModel()
{
    ...
    this.ApiURL = {
        getUserMsg: getUrl() + "/juxinli/GetUserInfo.ashx",//获取用户信息
        getDatasources: getUrl() + "/juxinli/datasources.ashx",//获取机构能力
        genToken: getUrl() + "/juxinli/applications.ashx",//生成token
        collectReq: getUrl() + "/juxinli/messages_req.ashx",//采集请求
        resetReq: getUrl()+ "/juxinli/messages_reset.ashx", //重置请求
        setFlag: getUrl() + "/juxinli/SetGetFlag.ashx",//设置采集完成标志
        hasReport: getUrl() +"/juxinli/hasReport.ashx",//判断是否已获取报告
        skipReq: getUrl()+ "/juxinli/messages_skip.ashx"//跳过当前数据源
    };
    this.currentStep = "";
    this.currentTask = "";
    this.currentWebsite = "";
